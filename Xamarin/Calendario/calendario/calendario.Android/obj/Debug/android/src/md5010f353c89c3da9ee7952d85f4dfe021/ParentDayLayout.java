...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Syncfusion.Schedule.ParentDayLayout, Syncfusion.SfSchedule.Android, Version=15.4451.0.17, Culture=neutral, PublicKeyToken=null", ParentDayLayout.class, __md_methods);
	}


	public ParentDayLayout (android.content.Context p0) throws java.lang.Throwable
	{
		super (p0);
		if (getClass () == ParentDayLayout.class)
			mono.android.TypeManager.Activate ("Com.Syncfusion.Schedule.ParentDayLayout, Syncfusion.SfSchedule.Android, Version=15.4451.0.17, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}


	public ParentDayLayout (android.content.Context p0, android.util.AttributeSet p1) throws java.lang.Throwable
	{
		super (p0, p1);
		if (getClass () == ParentDayLayout.class)
	...
	public ParentDayLayout (android.content.Context p0, android.util.AttributeSet p1, int p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
		if (getClass () == ParentDayLayout.class)
	...
	public ParentDayLayout (android.content.Context p0, android.util.AttributeSet p1, int p2, int p3) throws java.lang.Throwable
	{
		super (p0, p1, p2, p3);
		if (getClass () == ParentDayLayout.class)
