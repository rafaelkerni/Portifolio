...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Syncfusion.Schedule.AllDayAppointmentContainer, Syncfusion.SfSchedule.Android, Version=15.4451.0.17, Culture=neutral, PublicKeyToken=null", AllDayAppointmentContainer.class, __md_methods);
	}


	public AllDayAppointmentContainer (android.content.Context p0) throws java.lang.Throwable
	{
		super (p0);
	...
	public AllDayAppointmentContainer (android.content.Context p0, android.util.AttributeSet p1) throws java.lang.Throwable
	{
		super (p0, p1);
		if (getClass () == AllDayAppointmentContainer.class)
	...
	public AllDayAppointmentContainer (android.content.Context p0, android.util.AttributeSet p1, int p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
		if (getClass () == AllDayAppointmentContainer.class)
	...
	public AllDayAppointmentContainer (android.content.Context p0, android.util.AttributeSet p1, int p2, int p3) throws java.lang.Throwable
	{
		super (p0, p1, p2, p3);
		if (getClass () == AllDayAppointmentContainer.class)
